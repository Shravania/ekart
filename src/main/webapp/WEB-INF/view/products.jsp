      ...
      <div >
	    <div class="columns" ng-repeat="resource in names | filter:search">
  			<ul class="price">
    			...
    			<li><a href="../addToCart/{{ resource.id}}" class="button" role="button">Add To Cart</a></li>
   				<li class="grey"><a href="../Cart/buyNow/{{ resource.productId}}" class="button" role="button">Buy Now</a> </li>
  			</ul>
		</div>
  	</div>
</div>
